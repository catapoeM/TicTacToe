function start() {
	...
	function pickCell(idCell) {
		...
		// The first for loop checks all lines from the winning combination array
		for (var i = 0; combinations_x.length > 2 || combinations_0.length > 2 && i < winning_combinations.length; ++i) {
			...
			for (var j = 0; j < 3; ++j) {
				// this third for loop verify the equality between elements of the specific line and the x or 0 combinations array
